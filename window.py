...
class fenetre:
    def __init__(self, longueur, largeur, nom_fenetre="Simulation epidemie GEII", nom_icone='icone.jpg'):
    ...
    def creer_environnement(self, taille_env, couleur, forme="carre"):
        if forme == "carre":
